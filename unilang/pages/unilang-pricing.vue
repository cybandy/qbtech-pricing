...
<template>
    <div>
        <UContainer>
            ...
            <div class="section">
                <ElementPricingGrid>
                    <ElementPricingCardV1 v-for="(item, ind) of plans" v-bind="(item as any)"
        ...
        <div class="bg-primary-50 dark:bg-primary-950/30">
            <UContainer>
                <SectionHeroV2 title="Additional Tools & Services"
                    description="Upon further discussion, the ff tools and services will be decided upon depending on the project and client requirement, and the cost related to it will be bore by solely the client.">

                    <ElementPricingCardV1 :features="additionalInfo" title="General" cycle="" :price="0"
                        description="" />
                </SectionHeroV2>
            </UContainer>
        </div>
